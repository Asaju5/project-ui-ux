...
function PurchasedAirtime({ isAirtimePurchased, onClose }) {
  if (!isAirtimePurchased) return null;
  return (
      ...
      <div className="w-[600px] bg-[#0A221C] flex flex-col mx-4 rounded-lg py-2">
        ...
        <div className="flex flex-col items-center justify-center pt-10">
          <div className="flex flex-col py-4 items-center">
            <h4 className="text-md text-gray-200 font-semibold items-center flex flex-col">
              You have successfully Purchased Airtime{" "}
              <span> for 0901234567890</span>
            </h4>
          </div>
        </div>
...
export default PurchasedAirtime;
