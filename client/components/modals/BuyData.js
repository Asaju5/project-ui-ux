...
function BuyData({ isBuyData, onClose }) {
  if (!isBuyData) return null;
  return (
    <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center">
      <div className="w-[600px] bg-[#0A221C] flex flex-col mx-4 rounded-lg pt-2 pb-8">
        ...
        <div className="p-4 ml-4">
          <h4 className="text-xl font-semibold text-[#4BF0A5]">Buy Data</h4>
          <p className="text-sm text-gray-400">Top up your data balance</p>
        </div>
        ...
        <div className="flex flex-col bg-[#123F33] mx-4 md:mx-20 py-1 rounded-lg mt-4">
          <div className="flex flex-col ml-4 md:ml-10">
            ...
            <input
              type="number"
              inputMode="numeric"
              className="h-8 w-[80%] outline-none focus:outline-none focus:ring-0 border-none text-white bg-[#123f33] "
            />
          </div>
        </div>
        ...
        <div className="flex flex-col bg-[#123F33] mx-4 md:mx-20 py-1 rounded-lg mt-4">
          <div className="flex flex-col ml-4 md:ml-10">
            <p className="text-gray-400 text-sm">Select plan</p>
            <select
              className="bg-[#123f33] border-none rounded-lg py-2 px-3 text-white 
            leading-tight focus:outline-none focus:ring-0 mr-4"
            >
              <option>WKND 50GB</option>
              <option>WKND 100GB</option>
              <option>WKND 150GB</option>
              <option>WKND 200GB</option>
            </select>
          </div>
        </div>
        ...
        <div className="flex flex-col bg-[#4BF0A5] mx-4 md:mx-20 py-2.5 rounded-lg mt-4">
          <button className="font-semibold">Buy data</button>
        </div>
      </div>
    </div>
  );
